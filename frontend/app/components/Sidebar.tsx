    ...
    <aside className="w-48 flex flex-col justify-between border-r border-gray-800">
      ...
      <div>
        <div className="p-6 border-b border-gray-800">
          <h2 className="text-lg font-semibold text-accent">jobpal.</h2>
          <p className="text-sm text-gray-400 mt-1">{userName ? `Welcome, ${userName}` : "Welcome"}</p>
        </div>
      ...
      <div className="p-4 border-t border-gray-800">
        <button
          ...
          className="flex items-center gap-2 text-sm text-gray-400 hover:text-white transition-colors hover:cursor-pointer"
        >
